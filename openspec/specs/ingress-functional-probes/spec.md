# Ingress Functional Probes Specification

## Purpose

Define reusable bounded probes that distinguish socket reachability, public TLS
fallback, an authenticated transport path and a fresh expected-generation
heartbeat, without embedding transport secrets or provider identities.
