# Lightsail Ingress Module Specification

## Purpose

Define the reusable provider-neutral AWS Lightsail building block for an
independent provider-B ingress, while live account identity and deployment
state remain in private infrastructure.
