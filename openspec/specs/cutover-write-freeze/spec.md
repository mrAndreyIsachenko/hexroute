# Cutover Write Freeze Specification

## Purpose

Define the provider-neutral, transactionally enforced write freeze that makes a
PostgreSQL source safe to copy during cutover, while live freeze execution and
evidence remain in private infrastructure.
