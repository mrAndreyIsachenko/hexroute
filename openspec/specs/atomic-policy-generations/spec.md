# Atomic Policy Generations Specification

## Purpose

Define Hexroute's signed, atomic, generation-bound local authorization model
before any production data-plane capability is enabled.
