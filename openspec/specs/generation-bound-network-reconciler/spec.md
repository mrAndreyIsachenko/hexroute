# Generation-Bound Network Reconciler Specification

## Purpose

Define the synthetic-only, generation-bound reconciliation engine that turns a
fresh authorized proposal into typed, replayable local action state without
granting production network, process, VPN or credential mutation authority.
